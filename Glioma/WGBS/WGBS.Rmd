...
(enrich_IDHmut.enhancer.5mC.promoter.hyper.states.UP.DM)
kable(read.delim("/projects/epigenomics2/users/lli/glioma/WGBS/H3K27ac/IDHmut.enhancer.5mC.promoter.hyper.states.UP.DM.multi.gene", as.is = T, head = F), format = "html", align = "l", row.names = F, col.names = NULL)
kable(IDHmut_promoter_hyper_states_summary, format = "html", align = "c", row.names = F)
(enhancer_5mC_homer_known_promoter_figure)
(enhancer_5mC_homer_known_regular_figure)
(enhancer_5mC_homer_known_super_figure)
```
