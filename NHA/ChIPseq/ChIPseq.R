...
#### H3K27ac
K27ac_MGG119_vitc_unique <- round(as.numeric(system("less ./unique2/MGG_vitc.MGG119_control/H3K27ac/H3K27ac.MGG_vitc.MGG119_control.MGG_vitc.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27ac_MGG119_control_unique <- round(as.numeric(system("less ./unique2/MGG_vitc.MGG119_control/H3K27ac/H3K27ac.MGG_vitc.MGG119_control.MGG119_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27ac_NHAR_vitc_unique <- round(as.numeric(system("less ./unique2/NHAR_vitc.NHAR_control/H3K27ac/H3K27ac.NHAR_vitc.NHAR_control.NHAR_vitc.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27ac_NHAR_control_unique <- round(as.numeric(system("less ./unique2/NHAR_vitc.NHAR_control/H3K27ac/H3K27ac.NHAR_vitc.NHAR_control.NHAR_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27ac_NHA_mut_unique <- round(as.numeric(system("less ./unique2/NHAR_control.NHA_control/H3K27ac/H3K27ac.NHAR_control.NHA_control.NHAR_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27ac_NHA_wt_unique <- round(as.numeric(system("less ./unique2/NHAR_control.NHA_control/H3K27ac/H3K27ac.NHAR_control.NHA_control.NHA_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27ac_MGG119_vitc_CEMT_NPC_venn.pdf", height = 4, width = 4)
grid.draw(K27ac_MGG119_vitc_CEMT_NPC_venn)
dev.off()
K27ac_MGG119_control_CEMT_mut <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/MGG_vitc.MGG119_control/H3K27ac/H3K27ac.MGG_vitc.MGG119_control.MGG119_control.unique -b /projects/epigenomics2/users/lli/glioma/ChIPseq/unique/H3K27ac/IDHmut_NPC.IDHmut.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27ac_NHAR_vitc_CEMT_NPC_venn.pdf", height = 4, width = 4)
...
pdf("./unique2/K27ac_NHAR_control_CEMT_mut_venn.pdf", height = 4, width = 4)
...
pdf("./unique2/K27ac_MGG119_NHAR_vitc_venn.pdf", height = 4, width = 4)
...
pdf("./unique2/K27ac_MGG119_NHAR_control_venn.pdf", height = 4, width = 4)
...
pdf("./unique2/K27ac_NHA_mut_control_venn.pdf", height = 4, width = 4)
...
pdf("./unique2/K27ac_NHA_wt_vitc_venn.pdf", height = 4, width = 4)
grid.draw(K27ac_NHA_wt_vitc_venn)
dev.off()
K27ac_NHA_mut_MGG119_control <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/NHAR_control.NHA_control/H3K27ac/H3K27ac.NHAR_control.NHA_control.NHAR_control.unique -b ./unique2/MGG_vitc.MGG119_control/H3K27ac/H3K27ac.MGG_vitc.MGG119_control.MGG119_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27ac_NHA_mut_MGG119_control_venn.pdf", height = 4, width = 4)
...
pdf("./unique2/K27ac_NHA_wt_MGG119_vitc_venn.pdf", height = 4, width = 4)
...
e <- 1e-5
K27ac_mutGain_vitcLoss_GATA3_RPKM <- read.delim("./unique2/H3K27ac.mut_gain.vitc_loss.GATA3.closest.gene.RPKM", as.is = T) %>% mutate(log2FC1 = log2((NHAR_control+e)/(NHA_control+e)), log2FC2 = log2((NHAR_vitc+e)/(NHAR_control+e))) %>% filter(log2FC1*log2FC2 < 0, abs(log2FC1) >= 0.5, abs(log2FC2) >= 0.5) 
gene <- unique(K27ac_mutGain_vitcLoss_GATA3_RPKM$Name)
K27ac_mutGain_vitcLoss_GATA3_RPKM <- K27ac_mutGain_vitcLoss_GATA3_RPKM	%>% select(NHA_control:NHA_vitc) %>% unique() %>% 
...
(K27ac_mutGain_vitcLoss_GATA3_figure <- ggplot(K27ac_mutGain_vitcLoss_GATA3_RPKM, aes(x = variable, y = Name, fill = value)) + 
		geom_tile() + 
		scale_fill_gradient(name = "RPKM\nZ-score") + 
		ggtitle("H3K27ac mutant gain vitc loss GATA3 target genes") + 
		xlab("") + 
		ylab("") + 
		theme_bw() + 
		theme(axis.text.x = element_text(size = 12)))
ggsave(K27ac_mutGain_vitcLoss_GATA3_figure, file = "./unique2/K27ac_mutGain_vitcLoss_GATA3_figure.pdf", height = 7, width = 6)
K27ac_mutGain_vitcLoss_Foxo1_RPKM <- read.delim("./unique2/H3K27ac.mut_gain.vitc_loss.Foxo1.closest.gene.RPKM", as.is = T) %>% mutate(log2FC1 = log2((NHAR_control+e)/(NHA_control+e)), log2FC2 = log2((NHAR_vitc+e)/(NHAR_control+e))) %>% filter(log2FC1*log2FC2 < 0, abs(log2FC1) >= 0.5, abs(log2FC2) >= 0.5) 
gene <- unique(K27ac_mutGain_vitcLoss_Foxo1_RPKM$Name)
K27ac_mutGain_vitcLoss_Foxo1_RPKM <- K27ac_mutGain_vitcLoss_Foxo1_RPKM	%>% select(MGG119_control:NHA_vitc) %>% unique() %>% 
	t() %>% scale(center = T, scale = T) %>% t() %>% as.data.frame() %>% mutate(Name = gene) %>% arrange(NHAR_control-NHA_control) %>% mutate(Name = factor(Name, levels = Name)) %>% melt(id = "Name")
(K27ac_mutGain_vitcLoss_Foxo1_figure <- ggplot(K27ac_mutGain_vitcLoss_Foxo1_RPKM, aes(x = variable, y = Name, fill = value)) + 
		geom_tile() + 
		scale_fill_gradient(name = "Z-score") + 
		ggtitle("H3K27ac mutant gain vitc loss Foxo1 target genes") + 
		xlab("") + 
		ylab("") + 
		theme_bw() + 
		theme(axis.text.x = element_text(angle = 90, size = 12)))
ggsave(K27ac_mutGain_vitcLoss_Foxo1_figure, file = "./unique2/K27ac_mutGain_vitcLoss_Foxo1_figure.pdf", height = 7, width = 6)
#### H3K4me1
...
#### H3K27me3
K27me3_MGG119_vitc_unique <- round(as.numeric(system("less ./unique2/MGG_vitc.MGG119_control/H3K27me3/H3K27me3.MGG_vitc.MGG119_control.MGG_vitc.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27me3_MGG119_control_unique <- round(as.numeric(system("less ./unique2/MGG_vitc.MGG119_control/H3K27me3/H3K27me3.MGG_vitc.MGG119_control.MGG119_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27me3_NHAR_vitc_unique <- round(as.numeric(system("less ./unique2/NHAR_vitc.NHAR_control/H3K27me3/H3K27me3.NHAR_vitc.NHAR_control.NHAR_vitc.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27me3_NHAR_control_unique <- round(as.numeric(system("less ./unique2/NHAR_vitc.NHAR_control/H3K27me3/H3K27me3.NHAR_vitc.NHAR_control.NHAR_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27me3_NHA_mut_unique <- round(as.numeric(system("less ./unique2/NHAR_control.NHA_control/H3K27me3/H3K27me3.NHAR_control.NHA_control.NHAR_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
K27me3_NHA_wt_unique <- round(as.numeric(system("less ./unique2/NHAR_control.NHA_control/H3K27me3/H3K27me3.NHAR_control.NHA_control.NHA_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27me3_MGG119_vitc_CEMT_NPC_venn.pdf", height = 4, width = 4)
grid.draw(K27me3_MGG119_vitc_CEMT_NPC_venn)
dev.off()
K27me3_MGG119_control_CEMT_mut <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/MGG_vitc.MGG119_control/H3K27me3/H3K27me3.MGG_vitc.MGG119_control.MGG119_control.unique -b /projects/epigenomics2/users/lli/glioma/ChIPseq/unique/H3K27me3/IDHmut_NPC.IDHmut.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27me3_MGG119_control_CEMT_mut_venn.pdf", height = 4, width = 4)
grid.draw(K27me3_MGG119_control_CEMT_mut_venn)
dev.off()
K27me3_NHAR_vitc_CEMT_NPC <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/NHAR_vitc.NHAR_control/H3K27me3/H3K27me3.NHAR_vitc.NHAR_control.NHAR_vitc.unique -b /projects/epigenomics2/users/lli/glioma/ChIPseq/unique/H3K27me3/IDHmut_NPC.NPC.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27me3_NHAR_vitc_CEMT_NPC_venn.pdf", height = 4, width = 4)
grid.draw(K27me3_NHAR_vitc_CEMT_NPC_venn)
dev.off()
K27me3_NHAR_control_CEMT_mut <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/NHAR_vitc.NHAR_control/H3K27me3/H3K27me3.NHAR_vitc.NHAR_control.NHAR_control.unique -b /projects/epigenomics2/users/lli/glioma/ChIPseq/unique/H3K27me3/IDHmut_NPC.IDHmut.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27me3_NHAR_control_CEMT_mut_venn.pdf", height = 4, width = 4)
grid.draw(K27me3_NHAR_control_CEMT_mut_venn)
dev.off()
K27me3_MGG119_NHAR_vitc <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/MGG_vitc.MGG119_control/H3K27me3/H3K27me3.MGG_vitc.MGG119_control.MGG_vitc.unique -b ./unique2/NHAR_vitc.NHAR_control/H3K27me3/H3K27me3.NHAR_vitc.NHAR_control.NHAR_vitc.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27me3_MGG119_NHAR_vitc_venn.pdf", height = 4, width = 4)
grid.draw(K27me3_MGG119_NHAR_vitc_venn)
dev.off()
K27me3_MGG119_NHAR_control <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/MGG_vitc.MGG119_control/H3K27me3/H3K27me3.MGG_vitc.MGG119_control.MGG119_control.unique -b ./unique2/NHAR_vitc.NHAR_control/H3K27me3/H3K27me3.NHAR_vitc.NHAR_control.NHAR_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27me3_MGG119_NHAR_control_venn.pdf", height = 4, width = 4)
grid.draw(K27me3_MGG119_NHAR_control_venn)
dev.off()
K27me3_NHA_mut_control <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/NHAR_control.NHA_control/H3K27me3/H3K27me3.NHAR_control.NHA_control.NHAR_control.unique -b ./unique2/NHAR_vitc.NHAR_control/H3K27me3/H3K27me3.NHAR_vitc.NHAR_control.NHAR_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27me3_NHA_mut_control_venn.pdf", height = 4, width = 4)
grid.draw(K27me3_NHA_mut_control_venn)
dev.off()
K27me3_NHA_wt_vitc <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/NHAR_control.NHA_control/H3K27me3/H3K27me3.NHAR_control.NHA_control.NHA_control.unique -b ./unique2/NHAR_vitc.NHAR_control/H3K27me3/H3K27me3.NHAR_vitc.NHAR_control.NHAR_vitc.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27me3_NHA_wt_vitc_venn.pdf", height = 4, width = 4)
grid.draw(K27me3_NHA_wt_vitc_venn)
dev.off()
K27me3_NHA_mut_MGG119_control <- round(as.numeric(system("/gsc/software/linux-x86_64-centos5/bedtools/bedtools-2.25.0/bin/intersectBed -a ./unique2/NHAR_control.NHA_control/H3K27me3/H3K27me3.NHAR_control.NHA_control.NHAR_control.unique -b ./unique2/MGG_vitc.MGG119_control/H3K27me3/H3K27me3.MGG_vitc.MGG119_control.MGG119_control.unique | awk '{s=s+$3-$2}END{print s}'", intern = T))/10^6, 2)
...
pdf("./unique2/K27me3_NHA_mut_MGG119_control_venn.pdf", height = 4, width = 4)
...
pdf("./unique2/K27me3_NHA_wt_MGG119_vitc_venn.pdf", height = 4, width = 4)
