...
knitr::opts_chunk$set(message=FALSE, echo = FALSE, warning = FALSE, results = FALSE, fig.height = 6, fig.width = 8) 
...
```{r reversed_genomic_breakdown}
(vitc_reversed_genomic_breakdown_figure)
```

#### H3K27ac
* mut_gain.vitc_loss: `r system("less ./unique/H3K27ac.mut_gain.vitc_loss.bed | wc -l", intern = T)` regions.     
* mut_loss.vitc_gain: `r system("less ./unique/H3K27ac.mut_loss.vitc_gain.bed | wc -l", intern = T)` regions.     

```{r reversed_K27ac_venn, fig.height = 6, fig.width=4}
grid.newpage()
grid.draw(K27ac_NHA_mut_control_venn)
grid.newpage()
grid.draw(K27ac_NHA_wt_vitc_venn)
```
```{r reversed_K27ac_homer, fig.height = 3}
grid.newpage()
pushViewport(viewport(layout = grid.layout(1, 2)))
...
```
```{r reversed_K27ac_FoxL2, fig.height = 3}
(enrich_K27ac_mutGain_vitcLoss_FoxL2)
```
```{r reversed_K27ac_FoxL2RPKM, fig.height = 8}
(K27ac_mutGain_vitcLoss_FoxL2_figure)
```

#### H3K4me1
* mut_gain.vitc_loss: `r system("less ./unique/H3K4me1.mut_gain.vitc_loss.bed | wc -l", intern = T)` regions.     
* mut_loss.vitc_gain: `r system("less ./unique/H3K4me1.mut_loss.vitc_gain.bed | wc -l", intern = T)` regions.     

```{r reversed_K4me1_venn, fig.height = 3}
grid.newpage()
grid.draw(K4me1_NHA_mut_control_venn)
grid.newpage()
grid.draw(K4me1_NHA_wt_vitc_venn)
```
```{r reversed_K4me1_homer}
grid.newpage()
pushViewport(viewport(layout = grid.layout(1, 2)))
...
#### H3K4me3
* mut_gain.vitc_loss: `r system("less ./unique/H3K4me3.mut_gain.vitc_loss.bed | wc -l", intern = T)` regions.     
* mut_loss.vitc_gain: `r system("less ./unique/H3K4me3.mut_loss.vitc_gain.bed | wc -l", intern = T)` regions.     

```{r reversed_K4me3_venn, fig.height = 3}
grid.newpage()
...
#### H3K27me3
* mut_gain.vitc_loss: `r system("less ./unique/H3K27me3.mut_gain.vitc_loss.bed | wc -l", intern = T)` regions.     
* mut_loss.vitc_gain: `r system("less ./unique/H3K27me3.mut_loss.vitc_gain.bed | wc -l", intern = T)` regions.     

```{r reversed_K27me3_venn, fig.height = 5}
grid.newpage()
grid.draw(K27me3_NHA_mut_control_venn)
grid.newpage()
grid.draw(K27me3_NHA_wt_vitc_venn)
```
```{r reversed_K27me3_RPKM, fig.height=5, fig.width=6}
(K27me3_mutGain_vitcLoss_exon_figure)
(K27me3_mutGain_vitcLoss_promoter_figure)
```
```{r reversed_K27me3_enrich, fig.height=10}
(enrich_K27me3_mutGain_vitcLoss_exons)
(enrich_K27me3_mutGain_vitcLoss_promoters)
```

#### H3K36me3
* mut_gain.vitc_loss: `r system("less ./unique/H3K36me3.mut_gain.vitc_loss.bed | wc -l", intern = T)` regions.     
* mut_loss.vitc_gain: `r system("less ./unique/H3K36me3.mut_loss.vitc_gain.bed | wc -l", intern = T)` regions.     

```{r reversed_K36me3_venn, fig.height = 5}
grid.newpage()
grid.draw(K36me3_NHA_mut_control_venn)
grid.newpage()
grid.draw(K36me3_NHA_wt_vitc_venn)
```
```{r reversed_K36me3_RPKM, fig.height=5, fig.width=6}
(K36me3_mutGain_vitcLoss_exon_figure)
```
```{r reversed_K36me3_enrich, fig.height=7}
(enrich_K36me3_mutGain_vitcLoss_exons)
```
