...
```{r DE, results='asis'}
kable(GW_DE_summary, format = "html", row.names = T, align = "c")
...
```{r DE_trend}
(GW_DE_trend_figure)
(GW_DE_trend_cortex_figure)
(GW_DE_trend_GE_figure)
...
```{r DE_cortex, results='asis'}
kable(GW_UP_no_cortex[!(GW_UP_no_cortex$id %in% c(GE01_GE03DE$ID, GE01_GE04DE$ID, GE02_GE03DE$ID, GE02_GE04DE$ID, GE03_GE04DE$ID)), c("id", "name", "description")], format = "html", row.names = F, align = "c")
```

  + Genes activated during GW15-GW17 in GE, not cortex     
```{r DE_GE, results='asis'}
kable(GW_no_UP_GE[!(GW_no_UP_GE$id %in% c(cortex01_cortex03DE$ID, cortex01_cortex04DE$ID, cortex02_cortex03DE$ID, cortex02_cortex04DE$ID, cortex03_cortex04DE$ID)), c("id", "name", "description")], format = "html", row.names = F, align = "c")
```
