...
## Abstract
Epigenetic differences between genetically identical monozygotic (MZ) twins are well documented, but when these epigenetic differences arise and their role in early development is poorly understood. Genetic mutations to epigenetic regulators and epigenomic alterations are amongst the earliest events in brain cell transformation. However, little is known about the epigenetic landscape in normal brain progenitor cell types. Here, we characterized epigenomes and transcriptomes of brain tissue and primary cell types (mixed brain tissue, cortex and ganglionic eminence (GE) derived neurospheres) from four human fetuses including a pair of 17-gestational-week MZ twins, one 15-gestational-week and one 13-gestational-week fetuses. Differential methylation analysis identified similar numbers of unmethylated regions (UMRs) between MZ twins and between different cell types. Strikingly, DNA methylation asymmetry was observed in these regions between the twins in cortex and mixed brain tissue, as well as between cortex and GE neurospheres, with more UMRs in cortex than in GE. Among the cell type-specific UMRs proximally associated with protein-coding genes, key factors in brain development, such as GFAP, NFIX and FEZF1, were identified with differential expression between cortex and GE neurospheres. Both epigentic and expressional analysis revealed more dynamic changes between the neurospheres in 17-gestational-week compared to 13-gestataional-week. Comparing individuals at different developmental stages found higher number of 17-gestational-week specific UMRs and up-regulated genes, associated with neurogenesis. In particular, OLIG2, a neuron fate regulator was epigenetically turned on in 17-gestational-week individuals. Taken together, our results suggest that individual specific DNA methylation patterns can arise as early as 17-gestational weeks in fetal monozygotic twins, and epigenetic and transcriptional differences accumulates over time during early fetal brain development. 
