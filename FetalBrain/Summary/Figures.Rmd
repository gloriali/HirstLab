...
clab <- c(rep(c("red", "blue"), each = 4), rep("green", 2))
heatmap.2(regulator_5mC, ColSideColors = clab, Rowv = NA, Colv = NA, scale = "row", trace = "none", margins = c(11, 6), keysize = 1, density.info = "none", col = bluered(256), key.title = "", key.xlab = "")
legend(x = 0.3, y = 1, c("Brain", "Cortex", "GE"), col = c("green", "red", "blue"), lwd = 8, ncol = 3)
pdf("~/快盘/FetalBrain/Figures/FigureS13.pdf", height = 7, width = 8)
heatmap.2(regulator_5mC, ColSideColors = clab, Rowv = NA, Colv = NA, scale = "row", trace = "none", margins = c(11, 6), keysize = 1, density.info = "none", col = bluered(256), key.title = "", key.xlab = "")
legend(x = 0.3, y = 1, c("Brain", "Cortex", "GE"), col = c("green", "red", "blue"), lwd = 8, ncol = 3)
dev.off()
```
