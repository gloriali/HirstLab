...
grid.text("UMR frequency", x = unit(0.015, "npc"), y = unit(0.8, "npc"), rot = 90, gp=gpar(fontsize=15))
grid.text("No. of genes", x = unit(0.015, "npc"), y = unit(0.35, "npc"), rot = 90, gp=gpar(fontsize=15))
pdf("~/快盘/FetalBrain/Figures/Figure2a.pdf", height = 10, width = 12)
grid.newpage()
grid.draw(neurospheres_scale_figure_gt)
grid.text("UMR frequency", x = unit(0.015, "npc"), y = unit(0.8, "npc"), rot = 90, gp=gpar(fontsize=15))
grid.text("No. of genes", x = unit(0.015, "npc"), y = unit(0.35, "npc"), rot = 90, gp=gpar(fontsize=15))
...
ggsave(GOBP_Cortex02_GE02_WGBS_figure, file = "~/快盘/FetalBrain/Figures/Figure2b.pdf", height = 10, width = 12)
```
...
grid.text("UMR frequency", x = unit(0.015, "npc"), y = unit(0.8, "npc"), rot = 90, gp=gpar(fontsize=15))
grid.text("No. of genes", x = unit(0.015, "npc"), y = unit(0.35, "npc"), rot = 90, gp=gpar(fontsize=15))
pdf("~/快盘/FetalBrain/Figures/Figure3a.pdf", height = 10, width = 12)
grid.newpage()
grid.draw(GW_scale_figure_gt)
grid.text("UMR frequency", x = unit(0.015, "npc"), y = unit(0.8, "npc"), rot = 90, gp=gpar(fontsize=15))
grid.text("No. of genes", x = unit(0.015, "npc"), y = unit(0.35, "npc"), rot = 90, gp=gpar(fontsize=15))
...
(UMR_enhancer_summary_figure <- ggplot(UMR_enhancer_summary_tall, aes(x = Sample, y = value, fill = UMR)) + 
   ...
   theme_bw() + 
   theme(strip.text = element_text(size = 18), axis.title = element_text(size = 18), axis.text = element_text(size = 15), legend.text = element_text(size = 18)))
ggsave(UMR_enhancer_summary_figure, file = "~/快盘/FetalBrain/Figures/Figure3b.pdf", height = 10, width = 12)
```
...
(DMR_GW_TF_figure <- DMR_GW_TF_figure + 
   ...
   theme(strip.text = element_text(size = 18), axis.title = element_text(size = 18), axis.text = element_text(size = 15), legend.text = element_text(size = 18)))
ggsave(DMR_GW_TF_figure, file = "~/快盘/FetalBrain/Figures/Figure3c.pdf", height = 6, width = 12)
```
...
ggsave(GW_DE_summary_figure, file = "~/快盘/FetalBrain/Figures/Figure4a.pdf", height = 10, width = 12)
```
...
ggsave(GW_DE_trend_figure, file = "~/快盘/FetalBrain/Figures/Figure4b.pdf", height = 10, width = 12)
```
...
(GW_DE_trend_cortex_figure <- GW_DE_trend_cortex_figure + 
   ...
   theme(strip.text = element_text(size = 18), title = element_text(size = 18), axis.title = element_text(size = 18), axis.text = element_text(size = 15), legend.text = element_text(size = 18)))
ggsave(GW_DE_trend_cortex_figure, file = "~/快盘/FetalBrain/Figures/Figure4c.pdf", height = 10, width = 12)
```
...
(GW_DE_trend_GE_figure <- GW_DE_trend_GE_figure + 
   ...
   scale_size(range = c(1, 10)) + 
   theme(strip.text = element_text(size = 18), title = element_text(size = 18), axis.title = element_text(size = 18), axis.text = element_text(size = 15), legend.text = element_text(size = 18)))
ggsave(GW_DE_trend_GE_figure, file = "~/快盘/FetalBrain/Figures/Figure4d.pdf", height = 10, width = 12)
```
...
pdf("~/快盘/FetalBrain/Figures/Figure4e.pdf", height = 20, width = 8)
grid.arrange(clab_figure + ggtitle("Cortex"), GW_DE_heatmap_cortex, clab_figure + ggtitle("GE"), GW_DE_heatmap_GE, nrow = 4, heights = c(0.09, 0.41, 0.09, 0.41))
dev.off()
```
...
layOut(list(DMR_freq_MZ_figure + ggtitle("UMRs between MZ twins") + scale_fill_manual(values = c("blue", "red"), label = c("HuFNSC02 UMRs", "HuFNSC01 UMRs"), name = ""), 1, 1:3), 
       list(DMR_freq_WGBS_figure + ggtitle("UMRs between neurospheres") + scale_fill_manual(values = c("blue", "red"), label = c("GE UMRs", "Cortex UMRs"), name = ""), 2, 1:2), 
...
ggsave(DMR_TF_figure, file = "~/快盘/FetalBrain/Figures/FigureS7.pdf")
```
...
pdf("~/快盘/FetalBrain/Figures/FigureS8.pdf", height = 12, width = 12)
grid.arrange(isoform_neurospheres_DAVID, enrich_GW_isoform_gene_dup, nrow = 2, heights = 9:5)
grid.text("A", x = unit(0.015, "npc"), y = unit(0.98, "npc"), gp=gpar(fontsize = 20))
grid.text("B", x = unit(0.015, "npc"), y = unit(0.42, "npc"), gp=gpar(fontsize = 20))
dev.off()
...
ggsave(regulator_5mC_heatmap, file = "~/快盘/FetalBrain/Figures/FigureS12.pdf", height = 12, width = 12)
```
...
pdf("~/快盘/FetalBrain/Figures/FigureS13.pdf", height = 12, width = 12)
grid.arrange(miR_summary_figure, miR_DE_MZ_heatmap, miR_DE_neurospheres_heatmap, miR_DE_GW_heatmap, nrow = 2)
grid.text("A", x=unit(.02, "npc"), y=unit(.98, "npc"), gp=gpar(fontsize=20))
grid.text("B", x=unit(.52, "npc"), y=unit(.98, "npc"), gp=gpar(fontsize=20))
grid.text("C", x=unit(.02, "npc"), y=unit(.48, "npc"), gp=gpar(fontsize=20))
...
```{r histone_RPKM}
(HisMod_RPKM_figure)
ggsave(HisMod_RPKM_figure, file = "~/快盘/FetalBrain/Figures/FigureS14.pdf")
```
...
pdf("~/快盘/FetalBrain/Figures/FigureS16.pdf", height = 6, width = 12)
grid.arrange(chrEnd_WGBS_figure, chrEnd_GW_figure, nrow = 1, widths = 5:6)
grid.text("A", x = unit(0.015, "npc"), y = unit(0.98, "npc"), gp=gpar(fontsize = 20))
grid.text("B", x = unit(0.48, "npc"), y = unit(0.98, "npc"), gp=gpar(fontsize = 20))
dev.off()
