...
knitr::opts_chunk$set(message=FALSE, echo = FALSE, warning = FALSE, results = FALSE, fig.height = 8, fig.width = 8) 
...
MZ_scale[MZ_scale$Assay == "UMRs", "value"] <- c(as.numeric(c(system("less /projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.Brain-HuFNSC01_Brain-HuFNSC02.m0.75.d0.6.s300.c4.hypo | awk '{s=s+$7}END{print s}'", intern = T), system("less /projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.Cortex-HuFNSC01_Cortex-HuFNSC02.m0.75.d0.6.s300.c4.hypo | awk '{s=s+$7}END{print s}'", intern = T), system("less /projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.GE-HuFNSC01_GE-HuFNSC02.m0.75.d0.6.s300.c4.hypo | awk '{s=s+$7}END{print s}'", intern = T))), -as.numeric(c(system("less /projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.Brain-HuFNSC01_Brain-HuFNSC02.m0.75.d0.6.s300.c4.hyper | awk '{s=s+$7}END{print s}'", intern = T), system("less /projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.Cortex-HuFNSC01_Cortex-HuFNSC02.m0.75.d0.6.s300.c4.hyper | awk '{s=s+$7}END{print s}'", intern = T), system("less /projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.GE-HuFNSC01_GE-HuFNSC02.m0.75.d0.6.s300.c4.hyper | awk '{s=s+$7}END{print s}'", intern = T))))/1000
MZ_scale_figure <- ggplot(MZ_scale, aes(x = Sample, y = value, fill = DM_DE)) + 
   ...
   ylab("") + 
   theme_bw() + 
   theme(strip.text = element_text(size = 15), axis.title = element_text(size = 15), axis.text = element_text(size = 12), legend.text = element_text(size = 15), plot.margin = unit(c(1,1,1,1), "cm"), plot.background = element_rect(fill = "transparent"))
MZ_scale_figure_gt <- ggplot_gtable(ggplot_build(MZ_scale_figure))
grid.newpage()
grid.draw(MZ_scale_figure_gt)
grid.text("Total UMR length\n(Kb)", x = unit(0.05, "npc"), y = unit(0.8, "npc"), rot = 90, gp=gpar(fontsize=12))
grid.text("Total enhancer\nlength (Mb)", x = unit(0.05, "npc"), y = unit(0.5, "npc"), rot = 90, gp=gpar(fontsize=12))
grid.text("No. of DE genes", x = unit(0.04, "npc"), y = unit(0.25, "npc"), rot = 90, gp=gpar(fontsize=12))
pdf("Figure3a.pdf", height = 7, width = 5.5)
grid.draw(MZ_scale_figure_gt)
grid.text("Total UMR length\n(Kb)", x = unit(0.05, "npc"), y = unit(0.8, "npc"), rot = 90, gp=gpar(fontsize=12))
grid.text("Total enhancer\nlength (Mb)", x = unit(0.05, "npc"), y = unit(0.5, "npc"), rot = 90, gp=gpar(fontsize=12))
grid.text("No. of DE genes", x = unit(0.04, "npc"), y = unit(0.25, "npc"), rot = 90, gp=gpar(fontsize=12))
...
```{r MZ_RCircus}
UMR_MZ_Brain_hypo <- read.delim("/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.Brain-HuFNSC01_Brain-HuFNSC02.m0.75.d0.6.s300.c4.hypo.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(chromEnd = chromStart + 1, data = 1, PlotColors = "red") 
UMR_MZ_Brain_hyper <- read.delim("/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.Brain-HuFNSC01_Brain-HuFNSC02.m0.75.d0.6.s300.c4.hyper.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(chromEnd = chromStart + 1, data = 1, PlotColors = "blue") 
UMR_MZ_Cortex_hypo <- read.delim("/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.Cortex-HuFNSC01_Cortex-HuFNSC02.m0.75.d0.6.s300.c4.hypo.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(chromEnd = chromStart + 1, data = 1, PlotColors = "red") 
UMR_MZ_Cortex_hyper <- read.delim("/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.Cortex-HuFNSC01_Cortex-HuFNSC02.m0.75.d0.6.s300.c4.hyper.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(chromEnd = chromStart + 1, data = 1, PlotColors = "blue") 
UMR_MZ_GE_hypo <- read.delim("/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.GE-HuFNSC01_GE-HuFNSC02.m0.75.d0.6.s300.c4.hypo.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(chromEnd = chromStart + 1, data = 1, PlotColors = "red") 
UMR_MZ_GE_hyper <- read.delim("/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/DMR.GE-HuFNSC01_GE-HuFNSC02.m0.75.d0.6.s300.c4.hyper.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(chromEnd = chromStart + 1, data = 1, PlotColors = "blue") 
...
params$hist.width <- 50
RCircos.Reset.Plot.Parameters(params)
RCircos.Set.Plot.Area()
RCircos.Chromosome.Ideogram.Plot()
RCircos.Histogram.Plot(UMR_MZ_Brain_hypo, data.col=5, track.num=1, side="in")
RCircos.Histogram.Plot(UMR_MZ_Brain_hyper, data.col=5, track.num=2, side="in")
RCircos.Histogram.Plot(UMR_MZ_Cortex_hypo, data.col=5, track.num=4, side="in")
RCircos.Histogram.Plot(UMR_MZ_Cortex_hyper, data.col=5, track.num=5, side="in")
RCircos.Histogram.Plot(UMR_MZ_GE_hypo, data.col=5, track.num=7, side="in")
RCircos.Histogram.Plot(UMR_MZ_GE_hyper, data.col=5, track.num=8, side="in")
```
...
GREAT_HuFNSC01.UMR.Brain <- enrich_GREAT(file = "DMR.Brain-HuFNSC01_Brain-HuFNSC02.hypo", name = "Brain-HuFNSC01.UMRs", categories = "InterPro") + scale_fill_manual(values = "red", guide = "none") + ggtitle("Brain-Subject1 UMR")
GREAT_HuFNSC02.UMR.Brain <- enrich_GREAT(file = "DMR.Brain-HuFNSC01_Brain-HuFNSC02.hyper", name = "Brain-HuFNSC02.UMRs", categories = "InterPro") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("Brain-Subject2 UMR")
GREAT_HuFNSC01.UMR.Cortex <- enrich_GREAT(file = "DMR.Cortex-HuFNSC01_Cortex-HuFNSC02.hypo", name = "Cortex-HuFNSC01.UMRs", categories = "InterPro") + scale_fill_manual(values = "red", guide = "none") + ggtitle("Cortex-Subject1 UMR")
GREAT_HuFNSC02.UMR.Cortex <- enrich_GREAT(file = "DMR.Cortex-HuFNSC01_Cortex-HuFNSC02.hyper", name = "Cortex-HuFNSC02.UMRs", categories = "InterPro") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("Cortex-Subject2 UMR")
GREAT_HuFNSC01.UMR.GE <- enrich_GREAT(file = "DMR.GE-HuFNSC01_GE-HuFNSC02.hypo", name = "GE-HuFNSC01.UMRs", categories = "InterPro") + scale_fill_manual(values = "red", guide = "none") + ggtitle("GE-Subject1 UMR")
GREAT_HuFNSC02.UMR.GE <- enrich_GREAT(file = "DMR.GE-HuFNSC01_GE-HuFNSC02.hyper", name = "GE-HuFNSC02.UMRs", categories = "InterPro") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("GE-Subject2 UMR")
grid.newpage()
layOut(list(GREAT_HuFNSC01.UMR.Brain, 1, 1), 
       list(GREAT_HuFNSC02.UMR.Brain, 2, 1), 
       list(GREAT_HuFNSC01.UMR.Cortex, 1, 2),
       list(GREAT_HuFNSC02.UMR.Cortex, 2, 2),
       list(GREAT_HuFNSC01.UMR.GE, 1, 3),
       list(GREAT_HuFNSC02.UMR.GE, 2, 3))
setwd("/projects/epigenomics/users/lli/FetalBrain/Figures")
...
```{r MZ_UMR_DE}
(MZ_UMR_DE_DAVID)
ggsave(MZ_UMR_DE_DAVID, file = "Figure3d.pdf", height = 5, width = 6)
```
...
```{r NPCs_RCircus}
UMR_NPC_GW13_hypo <- read.delim("/projects/epigenomics/users/lli/FetalBrain/WGBS/DMR/DMR.Cortex-HuFNSC04_GE-HuFNSC04.m0.75.p0.005.d0.5.s300.c3.hypo.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(data = 1, PlotColors = "red") 
UMR_NPC_GW13_hyper <- read.delim("/projects/epigenomics/users/lli/FetalBrain/WGBS/DMR/DMR.Cortex-HuFNSC04_GE-HuFNSC04.m0.75.p0.005.d0.5.s300.c3.hyper.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(data = 1, PlotColors = "blue") 
UMR_NPC_GW17_hypo <- read.delim("/projects/epigenomics/users/lli/FetalBrain/WGBS/DMR/DMR.Cortex-HuFNSC02_GE-HuFNSC02.m0.75.p0.005.d0.5.s300.c3.hypo.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(data = 1, PlotColors = "red") 
UMR_NPC_GW17_hyper <- read.delim("/projects/epigenomics/users/lli/FetalBrain/WGBS/DMR/DMR.Cortex-HuFNSC02_GE-HuFNSC02.m0.75.p0.005.d0.5.s300.c3.hyper.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(data = 1, PlotColors = "blue") 
data(UCSC.HG19.Human.CytoBandIdeogram);
cyto.info <- UCSC.HG19.Human.CytoBandIdeogram;
chr.exclude <- "chrY";
num.inside <- 10;
...
RCircos.Set.Plot.Area()
RCircos.Chromosome.Ideogram.Plot()
RCircos.Histogram.Plot(UMR_NPC_GW17_hypo, data.col=5, track.num=1, side="in")
RCircos.Histogram.Plot(UMR_NPC_GW17_hyper, data.col=5, track.num=2, side="in")
RCircos.Histogram.Plot(UMR_NPC_GW13_hypo, data.col=5, track.num=4, side="in")
RCircos.Histogram.Plot(UMR_NPC_GW13_hyper, data.col=5, track.num=5, side="in")
legend("bottomright", c("Cortex UMR", "GE UMR"), col = c("red", "blue"), lwd = 8, cex = 0.8)
pdf(file="Figure4a.pdf", height=6, width=6, compress=TRUE)
RCircos.Set.Plot.Area()
RCircos.Chromosome.Ideogram.Plot()
RCircos.Histogram.Plot(UMR_NPC_GW17_hypo, data.col=5, track.num=1, side="in")
RCircos.Histogram.Plot(UMR_NPC_GW17_hyper, data.col=5, track.num=2, side="in")
...
(GOBP_Cortex02_GE02_WGBS_figure <- ggplot(data = GOBP_Cortex02_GE02_WGBS, aes(Term, FDR, fill = UMR)) +
  ...
  xlab("") + 
  ylab("-log10(FDR)") + 
  scale_fill_manual(values = c("red", "blue"), name = "", guide = "none") + 
  theme_bw() + 
  theme(axis.title = element_text(size = 15), axis.text = element_text(size = 15), legend.text = element_text(size = 15)))
ggsave(GOBP_Cortex02_GE02_WGBS_figure, file = "Figure4b.pdf", height = 9, width = 8)
```

## Figure 5: Differences between GW are asymmetric, with more GW17-specific UMRs and up-regulated genes    
### Figure 5a: UMR Circos 
```{r GW_RCircus}
UMR_GW_cortex_hypo <- read.delim("/projects/epigenomics/users/lli/FetalBrain/GW/DMR/DMR.Cortex-HuFNSC02_Cortex-HuFNSC04.m0.75.p0.005.d0.5.s300.c3.hyper.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(data = 1, PlotColors = "red") 
UMR_GW_cortex_hyper <- read.delim("/projects/epigenomics/users/lli/FetalBrain/GW/DMR/DMR.Cortex-HuFNSC02_Cortex-HuFNSC04.m0.75.p0.005.d0.5.s300.c3.hypo.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(data = 1, PlotColors = "blue") 
UMR_GW_GE_hypo <- read.delim("/projects/epigenomics/users/lli/FetalBrain/GW/DMR/DMR.GE-HuFNSC02_GE-HuFNSC04.m0.75.p0.005.d0.5.s300.c3.hyper.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(data = 1, PlotColors = "red") 
UMR_GW_GE_hyper <- read.delim("/projects/epigenomics/users/lli/FetalBrain/GW/DMR/DMR.GE-HuFNSC02_GE-HuFNSC04.m0.75.p0.005.d0.5.s300.c3.hypo.bed", head = F, col.names = c("Chromosome", "chromStart", "chromEnd", "ID")) %>% mutate(data = 1, PlotColors = "blue")
data(UCSC.HG19.Human.CytoBandIdeogram);
cyto.info <- UCSC.HG19.Human.CytoBandIdeogram;
chr.exclude <- "chrY";
num.inside <- 10;
...
RCircos.Set.Plot.Area()
RCircos.Chromosome.Ideogram.Plot()
RCircos.Histogram.Plot(UMR_GW_cortex_hypo, data.col=5, track.num=1, side="in")
RCircos.Histogram.Plot(UMR_GW_cortex_hyper, data.col=5, track.num=2, side="in")
RCircos.Histogram.Plot(UMR_GW_GE_hypo, data.col=5, track.num=4, side="in")
RCircos.Histogram.Plot(UMR_GW_GE_hyper, data.col=5, track.num=5, side="in")
legend("bottomright", c("GW13 UMR", "GW17 UMR"), col = c("red", "blue"), lwd = 8, cex = 0.8)
pdf(file="Figure5a.pdf", height=6, width=6, compress=TRUE)
RCircos.Set.Plot.Area()
RCircos.Chromosome.Ideogram.Plot()
RCircos.Histogram.Plot(UMR_GW_cortex_hypo, data.col=5, track.num=1, side="in")
RCircos.Histogram.Plot(UMR_GW_cortex_hyper, data.col=5, track.num=2, side="in")
...
GW_scale <- GW_scale %>% filter(Assay == "Enhancer UMRs")
(GW_scale_figure <- ggplot(GW_scale, aes(x = Cell, y = value, fill = DM_DE)) + 
   ...
   scale_fill_manual(values = c("red", "blue"), name = "", labels = c("GW13 UMR", "GW17 UMR")) + 
   scale_y_continuous(breaks = c(-1, -2, 1, 2, 3), labels = abs(c(-1, -2, 1, 2, 3))) + 
   xlab("") + 
   ylab("Fold enrichment") + 
   ggtitle("UMR enrichment in enhancers") +
   theme_bw() + 
   theme(strip.text = element_text(size = 15), axis.title = element_text(size = 15), axis.text = element_text(size = 12), legend.text = element_text(size = 12), title = element_text(size = 15)))
ggsave(GW_scale_figure, file = "Figure5b.pdf", height = 6, width = 5)
```
...
homer_unique_enhancer_GW_GW17only_figure$data <- homer_unique_enhancer_GW_GW17only_figure$data %>% mutate(TF = factor(gsub("AR-halfsite", "AR", TF), levels = c("AR", "PR", "Foxo1", "Ptf1a", "Olig2")))
grid.newpage()
...
pdf("Figure5c.pdf", height = 5, width = 7)
...
```{r GW_enhancer_TFBS_5mC_RPKM, fig.height=4, fig.width=6}
homer_unique_enhancer_GW_GW17only_targets_TF_5mCdelta_figure$data <- homer_unique_enhancer_GW_GW17only_targets_TF_5mCdelta_figure$data %>% filter(TF %in% c("Olig2", "Foxo1", "AR-halfsite")) %>% mutate(TF = gsub("AR-halfsite", "AR", TF), Category = gsub("delta_5mC", "Enhancer_delta_5mC", Category))
homer_unique_enhancer_GW_GW17only_targets_TF_RPKM_FC_figure$data <- homer_unique_enhancer_GW_GW17only_targets_TF_RPKM_FC_figure$data %>% filter(TF %in% c("Olig2", "Foxo1", "AR-halfsite"), Category == "Target_RPKM_GE_FC") %>% mutate(TF = gsub("AR-halfsite", "AR", TF), Category = gsub("Target_RPKM_GE_FC", "Target_RPKM_FC", Category))
grid.newpage()
layOut(list(homer_unique_enhancer_GW_GW17only_targets_TF_5mCdelta_figure + facet_wrap(~ Category) + theme(plot.margin=unit(c(1,-0.8,1,1), "cm"), plot.background = element_rect(fill = "transparent"), axis.text.y = element_text(size = 15)), 1, 1),
       list(homer_unique_enhancer_GW_GW17only_targets_TF_RPKM_FC_figure + facet_wrap(~ Category) + theme(axis.text.y = element_text(size = 0), axis.ticks.y = element_line(color = "transparent"), plot.margin=unit(c(1,1,1,0.1), "cm"), plot.background = element_rect(fill = "transparent"), axis.text.y = element_text(size = 15)), 1, 2)) 
pdf("Figure5d.pdf", height = 4, width = 8)
layOut(list(homer_unique_enhancer_GW_GW17only_targets_TF_5mCdelta_figure + facet_wrap(~ Category) + theme(plot.margin=unit(c(1,-0.8,1,1), "cm"), plot.background = element_rect(fill = "transparent"), axis.text.y = element_text(size = 15)), 1, 1),
       list(homer_unique_enhancer_GW_GW17only_targets_TF_RPKM_FC_figure + facet_wrap(~ Category) + theme(axis.text.y = element_text(size = 0), axis.ticks.y = element_line(color = "transparent"), plot.margin=unit(c(1,1,1,0.1), "cm"), plot.background = element_rect(fill = "transparent"), axis.text.y = element_text(size = 15)), 1, 2)) 
dev.off()
```
...
pdf("Figure6b.pdf", height = 7, width = 7)
grid.arrange(GW17only_Olig2_UMR_K4me1_heatmap, GW17only_Olig2_UMR_mC_heatmap, GW17only_Olig2_UMR_RPKM_heatmap, nrow = 1, widths = c(0.33, 0.33, 0.34))
dev.off()
```
...
(unique_enhancer_GW_Olig2_DE_DAVID_figure <- ggplot(data = unique_enhancer_GW_Olig2_DE_DAVID, aes(Term, -log10FDR, fill = Cell)) +
  ...
  theme_bw() +
  theme(axis.title = element_text(size = 15), axis.text = element_text(size = 15), legend.text = element_text(size = 15), plot.background = element_rect(fill = "transparent")))
ggsave(unique_enhancer_GW_Olig2_DE_DAVID_figure, file = "Figure6c.pdf", height = 6, width = 8)
```
...
colnames(gene_FetalBrain) <- gsub("HuFNSC0", "Subject", colnames(gene_FetalBrain))
gene_dend <- (1- (gene_FetalBrain %>% as.matrix %>% cor(method = "spearman"))) %>% as.dist %>% hclust %>% as.dendrogram %>% 
  set("by_labels_branches_col", value = c("Brain.Subject1", "Brain.Subject2"), TF_value = "green", type = "all") %>% 
  set("by_labels_branches_col", value = c("Cortex.Subject1", "Cortex.Subject2", "Cortex.Subject3", "Cortex.Subject4"), TF_value = "red", type = "all") %>% 
  set("by_labels_branches_col", value = c("GE.Subject1", "GE.Subject2", "GE.Subject3", "GE.Subject4"), TF_value = "blue", type = "all") %>% 
  set("by_labels_branches_lwd", value = colnames(gene_FetalBrain), TF_value = 2)
op <- par(mar = c(5, 4, 4, 8))
plot(gene_dend, main = "Protein-coding genes", horiz = TRUE)
par(op)
pdf("Figure7a.pdf", height = 5, width = 5)
par(mar = c(5, 4, 4, 8))
plot(gene_dend, main = "Protein-coding genes", horiz = TRUE)
dev.off()
```
...
```{r GW_DE_summary}
GW_DE_summary_tall <- GW_DE_summary_figure$data %>% mutate(GW = revalue(GW, c("GW15-GW13" = "GW13-GW15", "GW17-GW13" = "GW13-GW17", "GW17-GW15" = "GW15-GW17")), Sample = gsub("_.*", "", Sample), Sample = revalue(Sample, c("GW15-GW13" = "Subject3\nvs\nSubject4", "GW17-GW13.1" = "Subject1\nvs\nSubject4", "GW17-GW13.2" = "Subject2\nvs\nSubject4", "GW17-GW15.1" = "Subject1\nvs\nSubject3", "GW17-GW15.2" = "Subject2\nvs\nSubject3")))
(GW_DE_summary_figure <- ggplot(GW_DE_summary_tall, aes(Sample, value, fill = type)) + 
   ...
   scale_y_continuous(limits=c(-700, 700), breaks = c(-600, -400, -200, 0, 200, 400, 600), labels = c(600, 400, 200, 0, 200, 400, 600)) + 
   xlab("") + 
   ylab("No. of genes") + 
   theme_bw() + 
   theme(axis.text = element_text(size = 12), legend.text = element_text(size = 15), legend.title = element_text(size = 0)))
ggsave(GW_DE_summary_figure, file = "Figure7b.pdf", height = 6, width = 8)
```
...
```{r GW_DE_trend}
GW_DE_trend_figure$data <- rbind(GW_DE_trend_figure$data %>% mutate(cell = "Shared"), GW_DE_trend_cortex_figure$data %>% mutate(type = F, cell = "Cortex"), GW_DE_trend_GE_figure$data %>% mutate(type = F, cell = "GE")) 
GW_DE_trend_figure$data$trend <- gsub("notDE", "ST", GW_DE_trend_figure$data$trend)
(GW_DE_trend_figure <- GW_DE_trend_figure + 
   scale_size_continuous(name = "No. of genes", limits = c(0, 500), breaks = c(50, 100, 200, 300, 400, 500), range = c(1, 8)) + 
   scale_color_manual(name = "", values = c("UP-UP" = "purple", "DN-DN" = "green2", "UP-DN" = "orange", "DN-UP" = "gold", "UP-ST" = "red", "ST-UP" = "blue", "DN-ST" = "chocolate", "ST-DN" = "pink"), guide = "none") + 
   geom_text(data = GW_DE_trend_figure$data %>% filter(x == "GW15") %>% mutate(y = 1.9), aes(x = x, y = y, label = N), color = "black", size = 6) + 
   facet_grid(cell ~ trend) + 
   ylab("Relative expression level") + 
   ggtitle("") + 
   theme(strip.text = element_text(size = 15), title = element_text(size = 15), axis.title = element_text(size = 15), axis.text = element_text(size = 15, angle = 90), legend.text = element_text(size = 15)))
ggsave(GW_DE_trend_figure, file = "Figure7c.pdf", height = 6, width = 13)
```
...
pdf("Figure7d.pdf", height = 20, width = 8)
grid.arrange(clab_figure + ggtitle("Cortex"), GW_DE_heatmap_cortex, clab_figure + ggtitle("GE"), GW_DE_heatmap_GE, nrow = 4, heights = c(0.09, 0.41, 0.09, 0.41))
dev.off()
```
...
```{r SNP}
SNP <- read.delim("/projects/epigenomics/users/lli/FetalBrain/SNP/SNP.summary", head = F, col.names = c("Sample", "Type", "count")) %>% mutate(Sample = factor(gsub("_", "\nvs\n",  Sample), levels = c("Subject1\nvs\nSubject2", "Subject1\nvs\nSubject3", "Subject2\nvs\nSubject3", "Subject1\nvs\nSubject4", "Subject2\nvs\nSubject4", "Subject3\nvs\nSubject4")))
(SNP_figure <- ggplot(SNP, aes(x = Sample, y = count, fill = Type)) + 
   ...
   theme_bw()) 
ggsave(SNP_figure, file = "FigureS1b.pdf", height = 5, width = 8)
```
...
```{r MZ_scale_compare, eval = F, fig.height = 10, fig.width = 12}
FindER_enrichedBases <- FindER_summary %>% filter(Mark == "H3K4me1")
rownames(FindER_enrichedBases) <- FindER_enrichedBases$Sample
MZ_scale <- data.frame(Sample = rep(c(DMR_MZ_summary$Sample, DMR_neurospheres_summary$Sample), 7), 
                        Category = rep(c(rep("Individual specific", nrow(DMR_MZ_summary)), rep("Cell type specific", nrow(DMR_neurospheres_summary))), 7), 
...
```{r genomicBreak_MZ}
genomicBreak_MZ_tall <- genomicBreak_MZ_figure$data %>% mutate(DM = revalue(factor(DM), c("hyper" = "Subject2 UMRs", "hypo" = "Subject1 UMRs")))
(genomicBreak_MZ_figure <- ggplot(genomicBreak_MZ_tall, aes(x = Region, y = log2(FC), fill = Sample)) + 
  ...
  theme_bw())
ggsave(genomicBreak_MZ_figure, file = "FigureS2a.pdf", height = 4, width = 5)
```
...
```{r RPKM_his}
(HisMod_RPKM_figure)
ggsave(HisMod_RPKM_figure, file = "FigureS2b.pdf", height = 4, width = 7)
```
...
venn_MZ_UP <- venn.diagram(MZ_UP, filename = NULL, fill = c("green", "red", "blue"), main = "MZ DE UP in Subject1")
...
venn_MZ_DN <- venn.diagram(MZ_DN, filename = NULL, fill = c("green", "red", "blue"), main = "MZ DE UP in Subject2")
grid.arrange(gTree(children = venn_MZ_UP), gTree(children = venn_MZ_DN), nrow = 1)
pdf("FigureS2c.pdf", height = 4, width = 8)
grid.arrange(gTree(children = venn_MZ_UP), gTree(children = venn_MZ_DN), nrow = 1)
dev.off()
```
...
(DAVID_MZ_figure <- ggplot(DAVID_MZ, aes(x = Term, y = FDR, fill = Cell)) + 
   ...
   ggtitle("MZ twins") + 
   theme_bw())
ggsave(DAVID_MZ_figure, file = "FigureS2d.pdf", height = 3, width = 6)
```
...
GOBP_Cortex02_GE02_MeDIP_figure <- ggplot(data = GOBP_Cortex02_GE02_MeDIP, aes(Term, FDR, fill = UMR)) +
  ...
  theme_bw()
DMR_freq_neurospheres_figure$data <- DMR_freq_neurospheres_figure$data %>% mutate(donor = revalue(factor(donor), c("HuFNSC01" = "Subject1", "HuFNSC02" = "Subject2")))
grid.newpage()
...
pdf("FigureS3a.pdf", height = 8, width = 10)
layOut(list(valid_boxplot, 1:2, 1:3), 
       list(DMR_freq_neurospheres_figure + scale_fill_manual(values = c("blue", "red"), labels = c("GE UMRs", "Cortex UMRs"), name = ""), 1:2, 4:6), 
       list(GOBP_Cortex02_GE02_MeDIP_figure, 3:5, 1:4))
dev.off()
```
...
```{r NPCs_scale}
NPCs_scale <- data.frame(Donor = c(rep(c("Subject2", "Subject4", "Subject2", "Subject4", "Subject1", "Subject2", "Subject3", "Subject4"), 2), "Subject1", "Subject2", "Subject3", "Subject4"), 
                                 GW = c(rep(c("GW17", "GW13", "GW17", "GW13", "GW17", "GW17", "GW15", "GW13"), 2), "GW17", "GW17", "GW15", "GW13"), 
...
NPCs_scale <- filter(NPCs_scale, as.character(Assay) %in% c("DE genes", "Isoforms"))
NPCs_scale_figure <- ggplot(NPCs_scale, aes(x = Donor, y = value, fill = DM_DE)) + 
   geom_bar(stat="identity", position = "identity", width = 0.4) + 
   geom_hline(yintercept = 0) + 
   facet_grid(Assay ~ GW, scales = "free", space = "free_x") +
   scale_fill_manual(values = c("red", "blue", "black"), name = "", labels = c("UP cortex", "UP GE", "Isoforms")) + 
   scale_y_continuous(breaks = c(-500, -250, 0, 250, 500, 1000, 1500, 2000), labels = abs(c(-500, -250, 0, 250, 500, 1000, 1500, 2000))) + 
   xlab("") + 
   ylab("") + 
   theme_bw() + 
   theme(strip.text = element_text(size = 15), axis.text = element_text(size = 12), legend.text = element_text(size = 15))
NPCs_scale_figure_gt <- ggplot_gtable(ggplot_build(NPCs_scale_figure))
grid.newpage()
grid.draw(NPCs_scale_figure_gt)
grid.text("No. of genes", x = unit(0.02, "npc"), y = unit(0.5, "npc"), rot = 90, gp=gpar(fontsize=15))
pdf("FigureS3d.pdf", height = 4, width = 6)
grid.draw(NPCs_scale_figure_gt)
grid.text("No. of genes", x = unit(0.02, "npc"), y = unit(0.5, "npc"), rot = 90, gp=gpar(fontsize=15))
dev.off()
```
...
```{r 5hmC_histogram}
(WGBS_MeDIP_diff_summary_figure <- WGBS_MeDIP_diff_summary_figure + xlab("WGBS-MeDIP 5mC") + theme(legend.text = element_text(size = 15)))
ggsave(WGBS_MeDIP_diff_summary_figure, file = "FigureS3e.pdf", height = 3, width = 6)
```
...
GREAT_Cortex02.hydroxy <- enrich_GREAT(file = "hydroxy_Cortex02", name = "Cortex02.hydroxy", categories = "GOBP") + scale_fill_manual(values = "red", guide = "none") + ggtitle("5hmC Cortex")
GREAT_GE02.hydroxy <- enrich_GREAT(file = "hydroxy_GE02", name = "GE02.hydroxy", categories = "GOBP") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("5hmC GE")
grid.newpage()
layOut(list(GREAT_Cortex02.hydroxy, 1, 1), 
       list(GREAT_GE02.hydroxy, 1, 2)) 
setwd("/projects/epigenomics/users/lli/FetalBrain/Figures/")
pdf("FigureS3f.pdf", height = 6, width = 12)
layOut(list(GREAT_Cortex02.hydroxy, 1, 1), 
       list(GREAT_GE02.hydroxy, 1, 2)) 
dev.off()
```
...
ggsave(homer_core_enhancer_figure, file = "FigureS4a.pdf", height = 5, width = 7)
```
...
(DAVID_NPCs_figure <- ggplot(DAVID_NPCs, aes(x = Term, y = FDR, fill = DE)) + 
   ...
   ggtitle("NPCs") + 
   theme_bw())
ggsave(DAVID_NPCs_figure, file = "FigureS4b.pdf", height = 7, width = 6)
```
...
```{r isoform_DAVID_NPC}
(isoform_NPCs_DAVID <- isoform_cortex_GE_enrich$figure + xlab("") + theme(plot.margin=unit(c(1,1.35,1,1), "cm")) + ggtitle("NPC isoforms"))
ggsave(isoform_NPCs_DAVID, file = "FigureS4c.pdf", height = 7, width = 8)
```

### Figure S4d: UMR - DM his - DE

```{r UMR_DM_DE_NPC}
(Cortex02_GE02DE_epi_figure)
ggsave(Cortex02_GE02DE_epi_figure, file = "FigureS4d.pdf", height = 3, width = 8)
```
...
pdf("FigureS5a.pdf", height = 10, width = 13)
layOut(list(GREAT_GW_Cortex_figure, 1:3, 1:4), 
       list(GREAT_GW_GE_figure, 1:4, 5:9), 
       list(GREAT_GW_shared_figure, 4:6, 1:4))
dev.off()
```
...
```{r DMhis_DE_DAVID}
(DM_H3K27me3_DE_GW_GE_DAVID <- DM_H3K27me3_DE_GW_GE_DAVID + xlab("") + ggtitle("DM H3K27me3 DE"))
ggsave(DM_H3K27me3_DE_GW_GE_DAVID, file = "FigureS5d.pdf", height = 4, width = 7)
```
...
DM_H3K4me3_GW_GE_GW13_DAVID <- enrich("DM_H3K4me3_GW_GE_GW13.pc", erminej = F, category = "GOBP") + scale_fill_manual(values = "red", guide = "none") + ggtitle("H3K4me3 GW13")
DM_H3K4me3_GW_GE_GW17_DAVID <- enrich("DM_H3K4me3_GW_GE_GW17.pc", erminej = F, category = "GOBP") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("H3K4me3 GW17")
DM_H3K27me3_GW_GE_GW13_DAVID <- enrich("DM_H3K27me3_GW_GE_GW13.pc", erminej = F, category = "GOBP") + scale_fill_manual(values = "red", guide = "none") + ggtitle("H3K27me3 GW13")
DM_H3K27me3_GW_GE_GW17_DAVID <- enrich("DM_H3K27me3_GW_GE_GW17.pc", erminej = F, category = "GOBP") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("H3K27me3 GW17")
grid.newpage()
layOut(list(DM_H3K4me3_GW_GE_GW13_DAVID, 1:3, 1), 
       list(DM_H3K4me3_GW_GE_GW17_DAVID, 4:5, 1), 
       list(DM_H3K27me3_GW_GE_GW13_DAVID, 1:3, 2),
       list(DM_H3K27me3_GW_GE_GW17_DAVID, 4:5, 2)) 
setwd("/projects/epigenomics/users/lli/FetalBrain/Figures/")
pdf("FigureS5e.pdf", height = 4, width = 12)
layOut(list(DM_H3K4me3_GW_GE_GW13_DAVID, 1:3, 1), 
       list(DM_H3K4me3_GW_GE_GW17_DAVID, 4:5, 1), 
       list(DM_H3K27me3_GW_GE_GW13_DAVID, 1:3, 2),
       list(DM_H3K27me3_GW_GE_GW17_DAVID, 4:5, 2)) 
...
colnames(nc_FetalBrain) <- gsub("HuFNSC0", "Subject", colnames(nc_FetalBrain))
...
colnames(exon_FetalBrain) <- gsub("HuFNSC0", "Subject", colnames(exon_FetalBrain))
...
colnames(miR_FetalBrain) <- gsub("0(\\d)", "\\.Subject\\1", colnames(miR_FetalBrain))
...
par(op)
pdf("FigureS6a.pdf", height = 8, width = 8)
