...
```{r MZ_UMR_GREAT}
GREAT_HuFNSC01.UMR.Brain <- enrich_GREAT(dirIn = "/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/enrich/", file = "DMR.Brain-HuFNSC01_Brain-HuFNSC02.hypo", name = "Brain-HuFNSC01.UMRs", categories = "InterPro") + scale_fill_manual(values = "red", guide = "none") + ggtitle("Brain-Subject1 UMR")
GREAT_HuFNSC02.UMR.Brain <- enrich_GREAT(dirIn = "/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/enrich/", file = "DMR.Brain-HuFNSC01_Brain-HuFNSC02.hyper", name = "Brain-HuFNSC02.UMRs", categories = "InterPro") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("Brain-Subject2 UMR")
GREAT_HuFNSC01.UMR.Cortex <- enrich_GREAT(dirIn = "/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/", file = "DMR.Cortex-HuFNSC01_Cortex-HuFNSC02.hypo", name = "Cortex-HuFNSC01.UMRs", categories = "InterPro") + scale_fill_manual(values = "red", guide = "none") + ggtitle("Cortex-Subject1 UMR")
GREAT_HuFNSC02.UMR.Cortex <- enrich_GREAT(dirIn = "/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/", file = "DMR.Cortex-HuFNSC01_Cortex-HuFNSC02.hyper", name = "Cortex-HuFNSC02.UMRs", categories = "InterPro") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("Cortex-Subject2 UMR")
GREAT_HuFNSC01.UMR.GE <- enrich_GREAT(dirIn = "/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/", file = "DMR.GE-HuFNSC01_GE-HuFNSC02.hypo", name = "GE-HuFNSC01.UMRs", categories = "InterPro") + scale_fill_manual(values = "red", guide = "none") + ggtitle("GE-Subject1 UMR")
GREAT_HuFNSC02.UMR.GE <- enrich_GREAT(dirIn = "/projects/epigenomics/users/lli/FetalBrain/MeDIP/DMR/", file = "DMR.GE-HuFNSC01_GE-HuFNSC02.hyper", name = "GE-HuFNSC02.UMRs", categories = "InterPro") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("GE-Subject2 UMR")
grid.newpage()
...
pdf("Figure2b.pdf", height = 4, width = 12)
layOut(list(GREAT_HuFNSC01.UMR.Brain, 1, 1), 
       list(GREAT_HuFNSC02.UMR.Brain, 2, 1), 
       list(GREAT_HuFNSC01.UMR.Cortex, 1, 2),
       list(GREAT_HuFNSC02.UMR.Cortex, 2, 2),
...
```{r MZ_UMR_DM_DE, height=3, eval=FALSE}
...
pdf("Figure2d.pdf", height = 3, width = 8)
grid.arrange(gTree(children = venn_Brain01_Brain02DE_epi), gTree(children = venn_Cortex01_Cortex02DE_epi), gTree(children = venn_GE01_GE02DE_epi), nrow = 1)
dev.off()
```
...
```{r 5hmC_GREAT}
GREAT_Cortex02.hydroxy <- enrich_GREAT(dirIn = "/projects/epigenomics/users/lli/FetalBrain/WGBS_MeDIP/enrich/", file = "hydroxy_Cortex02", name = "Cortex02.hydroxy", categories = "GOBP") + scale_fill_manual(values = "red", guide = "none") + ggtitle("5hmC Cortex")
GREAT_GE02.hydroxy <- enrich_GREAT(dirIn = "/projects/epigenomics/users/lli/FetalBrain/WGBS_MeDIP/enrich/", file = "hydroxy_GE02", name = "GE02.hydroxy", categories = "GOBP") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("5hmC GE")
grid.newpage()
layOut(list(GREAT_Cortex02.hydroxy, 1, 1), 
       list(GREAT_GE02.hydroxy, 1, 2)) 
pdf("FigureS3c.pdf", height = 6, width = 12)
layOut(list(GREAT_Cortex02.hydroxy, 1, 1), 
       list(GREAT_GE02.hydroxy, 1, 2)) 
dev.off()
```
...
```{r DMhis_DAVID_GW}
DM_H3K4me3_GW_GE_GW13_DAVID <- enrich("DM_H3K4me3_GW_GE_GW13.pc", dirIn = "/projects/epigenomics/users/lli/FetalBrain/ChIPseq/signal/enrich/", erminej = F, category = "GOBP") + scale_fill_manual(values = "red", guide = "none") + ggtitle("H3K4me3 GW13")
DM_H3K4me3_GW_GE_GW17_DAVID <- enrich("DM_H3K4me3_GW_GE_GW17.pc", dirIn = "/projects/epigenomics/users/lli/FetalBrain/ChIPseq/signal/enrich/", erminej = F, category = "GOBP") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("H3K4me3 GW17")
DM_H3K27me3_GW_GE_GW13_DAVID <- enrich("DM_H3K27me3_GW_GE_GW13.pc", dirIn = "/projects/epigenomics/users/lli/FetalBrain/ChIPseq/signal/enrich/", erminej = F, category = "GOBP") + scale_fill_manual(values = "red", guide = "none") + ggtitle("H3K27me3 GW13")
DM_H3K27me3_GW_GE_GW17_DAVID <- enrich("DM_H3K27me3_GW_GE_GW17.pc", dirIn = "/projects/epigenomics/users/lli/FetalBrain/ChIPseq/signal/enrich/", erminej = F, category = "GOBP") + scale_fill_manual(values = "blue", guide = "none") + ggtitle("H3K27me3 GW17")
grid.newpage()
...
pdf("FigureS5b.pdf", height = 4, width = 12)
layOut(list(DM_H3K4me3_GW_GE_GW13_DAVID, 1:3, 1), 
       list(DM_H3K4me3_GW_GE_GW17_DAVID, 4:5, 1), 
       list(DM_H3K27me3_GW_GE_GW13_DAVID, 1:3, 2),
       list(DM_H3K27me3_GW_GE_GW17_DAVID, 4:5, 2)) 
