...
brain01_02_isoform_all_gene <- brain01_02_isoform_all[!duplicated(brain01_02_isoform_all$id), ]
cortex01_02_isoform_all_gene <- cortex01_02_isoform_all[!duplicated(cortex01_02_isoform_all$id), ]
ge01_02_isoform_all_gene <- ge01_02_isoform_all[!duplicated(ge01_02_isoform_all$id), ]
cortex03_04_isoform_all_gene <- cortex03_04_isoform_all[!duplicated(cortex03_04_isoform_all$id), ]
ge03_04_isoform_all_gene <- ge03_04_isoform_all[!duplicated(ge03_04_isoform_all$id), ]
# all isoforms: gene list of different sections of Venn diagram (b: brain01_02, c: cortex01_02, g: ge01_02)
all_b_only <- geneRPKM[geneRPKM$id %in% setdiff(brain01_02_isoform_all_gene$id, union(cortex01_02_isoform_all_gene$id, ge01_02_isoform_all_gene$id)), ]
all_c_only <- geneRPKM[geneRPKM$id %in% setdiff(cortex01_02_isoform_all_gene$id, union(brain01_02_isoform_all_gene$id, ge01_02_isoform_all_gene$id)), ]
all_g_only <- geneRPKM[geneRPKM$id %in% setdiff(ge01_02_isoform_all_gene$id, union(brain01_02_isoform_all_gene$id, cortex01_02_isoform_all_gene$id)), ]
all_b_c_not_g <- geneRPKM[geneRPKM$id %in% setdiff(intersect(brain01_02_isoform_all_gene$id, cortex01_02_isoform_all_gene$id), ge01_02_isoform_all_gene$id), ]
all_b_g_not_c <- geneRPKM[geneRPKM$id %in% setdiff(intersect(brain01_02_isoform_all_gene$id, ge01_02_isoform_all_gene$id), cortex01_02_isoform_all_gene$id), ]
all_c_g_not_b <- geneRPKM[geneRPKM$id %in% setdiff(intersect(cortex01_02_isoform_all_gene$id, ge01_02_isoform_all_gene$id), brain01_02_isoform_all_gene$id), ]
all_b_c_g <- geneRPKM[geneRPKM$id %in% intersect(intersect(brain01_02_isoform_all_gene$id, cortex01_02_isoform_all_gene$id), ge01_02_isoform_all_gene$id), ]
...
brain01_02_isoform_all$exon_start <- as.numeric(gsub("-[0-9]+<[-_ENSG0-9]+", "", gsub("chr[0-9XY]+:", "", brain01_02_isoform_all$V1)))
brain01_02_isoform_all$exon_end <- as.numeric(gsub("<[-_ENSG0-9]+", "", gsub("chr[0-9XY:]+-", "", brain01_02_isoform_all$V1)))
brain01_02_isoform_all$exon_length <- abs(brain01_02_isoform_all$exon_end - brain01_02_isoform_all$exon_start)
cortex01_02_isoform_all$exon_start <- as.numeric(gsub("-[0-9]+<[-_ENSG0-9]+", "", gsub("chr[0-9XY]+:", "", cortex01_02_isoform_all$V1)))
cortex01_02_isoform_all$exon_end <- as.numeric(gsub("<[-_ENSG0-9]+", "", gsub("chr[0-9XY:]+-", "", cortex01_02_isoform_all$V1)))
cortex01_02_isoform_all$exon_length <- abs(cortex01_02_isoform_all$exon_end - cortex01_02_isoform_all$exon_start)
ge01_02_isoform_all$exon_start <- as.numeric(gsub("-[0-9]+<[-_ENSG0-9]+", "", gsub("chr[0-9XY]+:", "", ge01_02_isoform_all$V1)))
ge01_02_isoform_all$exon_end <- as.numeric(gsub("<[-_ENSG0-9]+", "", gsub("chr[0-9XY:]+-", "", ge01_02_isoform_all$V1)))
ge01_02_isoform_all$exon_length <- abs(ge01_02_isoform_all$exon_end - ge01_02_isoform_all$exon_start)
all_b_only$exon_length <- sapply(all_b_only$id, function(x) mean(brain01_02_isoform_all[brain01_02_isoform_all$id == x, "exon_length"]))
all_c_only$exon_length <- sapply(all_c_only$id, function(x) mean(cortex01_02_isoform_all[cortex01_02_isoform_all$id == x, "exon_length"]))
all_g_only$exon_length <- sapply(all_g_only$id, function(x) mean(ge01_02_isoform_all[ge01_02_isoform_all$id == x, "exon_length"]))
all_b_c_not_g$exon_length <- sapply(all_b_c_not_g$id, function(x) mean(c(brain01_02_isoform_all[brain01_02_isoform_all$id == x, "exon_length"], cortex01_02_isoform_all[cortex01_02_isoform_all$id == x, "exon_length"])))
all_b_g_not_c$exon_length <- sapply(all_b_g_not_c$id, function(x) mean(c(brain01_02_isoform_all[brain01_02_isoform_all$id == x, "exon_length"], ge01_02_isoform_all[ge01_02_isoform_all$id == x, "exon_length"])))
all_c_g_not_b$exon_length <- sapply(all_c_g_not_b$id, function(x) mean(c(cortex01_02_isoform_all[cortex01_02_isoform_all$id == x, "exon_length"], ge01_02_isoform_all[ge01_02_isoform_all$id == x, "exon_length"])))
all_b_c_g$exon_length <- sapply(all_b_c_g$id, function(x) mean(c(brain01_02_isoform_all[brain01_02_isoform_all$id == x, "exon_length"], cortex01_02_isoform_all[cortex01_02_isoform_all$id == x, "exon_length"], ge01_02_isoform_all[ge01_02_isoform_all$id == x, "exon_length"])))
# validated isoforms: gene list of different sections of Venn diagram (b: brain01_02, c: cortex01_02, g: ge01_02)
valid_b_only <- geneRPKM[geneRPKM$id %in% setdiff(brain01_02_isoform_valid_gene$gene, union(cortex01_02_isoform_valid_gene$gene, ge01_02_isoform_valid_gene$gene)), ]
valid_c_only <- geneRPKM[geneRPKM$id %in% setdiff(cortex01_02_isoform_valid_gene$gene, union(brain01_02_isoform_valid_gene$gene, ge01_02_isoform_valid_gene$gene)), ]
valid_g_only <- geneRPKM[geneRPKM$id %in% setdiff(ge01_02_isoform_valid_gene$gene, union(brain01_02_isoform_valid_gene$gene, cortex01_02_isoform_valid_gene$gene)), ]
valid_b_c_not_g <- geneRPKM[geneRPKM$id %in% setdiff(intersect(brain01_02_isoform_valid_gene$gene, cortex01_02_isoform_valid_gene$gene), ge01_02_isoform_valid_gene$gene), ]
valid_b_g_not_c <- geneRPKM[geneRPKM$id %in% setdiff(intersect(brain01_02_isoform_valid_gene$gene, ge01_02_isoform_valid_gene$gene), cortex01_02_isoform_valid_gene$gene), ]
valid_c_g_not_b <- geneRPKM[geneRPKM$id %in% setdiff(intersect(cortex01_02_isoform_valid_gene$gene, ge01_02_isoform_valid_gene$gene), brain01_02_isoform_valid_gene$gene), ]
valid_b_c_g <- geneRPKM[geneRPKM$id %in% intersect(intersect(brain01_02_isoform_valid_gene$gene, cortex01_02_isoform_valid_gene$gene), ge01_02_isoform_valid_gene$gene), ]
...
brain01_02_isoform_valid$exon_start <- as.numeric(gsub("-[0-9]+<[-_ENSG0-9]+", "", gsub("chr[0-9XY]+:", "", brain01_02_isoform_valid$exon)))
brain01_02_isoform_valid$exon_end <- as.numeric(gsub("<[-_ENSG0-9]+", "", gsub("chr[0-9XY:]+-", "", brain01_02_isoform_valid$exon)))
brain01_02_isoform_valid$exon_length <- abs(brain01_02_isoform_valid$exon_end - brain01_02_isoform_valid$exon_start)
cortex01_02_isoform_valid$exon_start <- as.numeric(gsub("-[0-9]+<[-_ENSG0-9]+", "", gsub("chr[0-9XY]+:", "", cortex01_02_isoform_valid$exon)))
cortex01_02_isoform_valid$exon_end <- as.numeric(gsub("<[-_ENSG0-9]+", "", gsub("chr[0-9XY:]+-", "", cortex01_02_isoform_valid$exon)))
cortex01_02_isoform_valid$exon_length <- abs(cortex01_02_isoform_valid$exon_end - cortex01_02_isoform_valid$exon_start)
ge01_02_isoform_valid$exon_start <- as.numeric(gsub("-[0-9]+<[-_ENSG0-9]+", "", gsub("chr[0-9XY]+:", "", ge01_02_isoform_valid$exon)))
ge01_02_isoform_valid$exon_end <- as.numeric(gsub("<[-_ENSG0-9]+", "", gsub("chr[0-9XY:]+-", "", ge01_02_isoform_valid$exon)))
ge01_02_isoform_valid$exon_length <- abs(ge01_02_isoform_valid$exon_end - ge01_02_isoform_valid$exon_start)
brain01_02_isoform_valid$gene <- as.character(brain01_02_isoform_valid$gene)
cortex01_02_isoform_valid$gene <- as.character(cortex01_02_isoform_valid$gene)
ge01_02_isoform_valid$gene <- as.character(ge01_02_isoform_valid$gene)
cortex03_04_isoform_valid$gene <- as.character(cortex03_04_isoform_valid$gene)
ge03_04_isoform_valid$gene <- as.character(ge03_04_isoform_valid$gene)
valid_b_only$exon_length <- sapply(valid_b_only$id, function(x) mean(brain01_02_isoform_valid[brain01_02_isoform_valid$gene == x, "exon_length"]))
valid_c_only$exon_length <- sapply(valid_c_only$id, function(x) mean(cortex01_02_isoform_valid[cortex01_02_isoform_valid$gene == x, "exon_length"]))
valid_g_only$exon_length <- sapply(valid_g_only$id, function(x) mean(ge01_02_isoform_valid[ge01_02_isoform_valid$gene == x, "exon_length"]))
valid_b_c_not_g$exon_length <- sapply(valid_b_c_not_g$id, function(x) mean(c(brain01_02_isoform_valid[brain01_02_isoform_valid$gene == x, "exon_length"], cortex01_02_isoform_valid[cortex01_02_isoform_valid$gene == x, "exon_length"])))
valid_b_g_not_c$exon_length <- sapply(valid_b_g_not_c$id, function(x) mean(c(brain01_02_isoform_valid[brain01_02_isoform_valid$gene == x, "exon_length"], ge01_02_isoform_valid[ge01_02_isoform_valid$gene == x, "exon_length"])))
valid_c_g_not_b$exon_length <- sapply(valid_c_g_not_b$id, function(x) mean(c(cortex01_02_isoform_valid[cortex01_02_isoform_valid$gene == x, "exon_length"], ge01_02_isoform_valid[ge01_02_isoform_valid$gene == x, "exon_length"])))
valid_b_c_g$exon_length <- sapply(valid_b_c_g$id, function(x) mean(c(brain01_02_isoform_valid[brain01_02_isoform_valid$gene == x, "exon_length"], cortex01_02_isoform_valid[cortex01_02_isoform_valid$gene == x, "exon_length"], ge01_02_isoform_valid[ge01_02_isoform_valid$gene == x, "exon_length"])))
isoform_all <- list(brain01_02 = brain01_02_isoform_all_gene$id, cortex01_02 = cortex01_02_isoform_all_gene$id, ge01_02 = ge01_02_isoform_all_gene$id)
isoform_valid <- list(brain01_02 = as.character(brain01_02_isoform_valid_gene$gene), cortex01_02 = as.character(cortex01_02_isoform_valid_gene$gene), ge01_02 = as.character(ge01_02_isoform_valid_gene$gene))
