...
lines(ecdf(brain02$V3), col = 2, lwd = 2)
...
legend("topleft", c("non-strand specific", "strand specific"), col = 1:2, lwd = 5)
...
lines(ecdf(junction$brain01rpkm), col = 1, lwd = 2)
lines(ecdf(junction$brain02rpkm), col = 2, lwd = 2)
lines(ecdf(junction$cortex01rpkm), col = 1, lwd = 2)
lines(ecdf(junction$cortex02rpkm), col = 1, lwd = 2)
lines(ecdf(junction$cortex03rpkm), col = 1, lwd = 2)
lines(ecdf(junction$cortex04rpkm), col = 2, lwd = 2)
lines(ecdf(junction$ge01rpkm), col = 1, lwd = 2)
lines(ecdf(junction$ge02rpkm), col = 1, lwd = 2)
lines(ecdf(junction$ge03rpkm), col = 2, lwd = 2)
lines(ecdf(junction$ge04rpkm), col = 2, lwd = 2)
legend("topleft", c("non-strand specific", "strand specific"), col = 1:2, lwd = 5)
