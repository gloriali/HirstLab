...
### Summary and sanity check
  ...
  * Average length of all DMRs is __`r as.integer(mean(DMR_pos_MZ_figure$data$length))`bp__. __Smaller__ than observed in breast. _Bad script or biology?_      
  * Average No. of CpGs per DMR is __`r as.integer(mean(DMR_pos_MZ_figure$data$count))`__. __Same__ as in breast.        
  * Average distance between adjacent DMRs is approximately __`r as.integer(mean(DMR_pos_MZ_figure$data$dis[DMR_pos_MZ_figure$data$dis != -100000])/1000)`Kb__.         
