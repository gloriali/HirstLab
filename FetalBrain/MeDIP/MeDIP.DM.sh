...
awk 'NR==FNR {twin1[$1]=$2; twin2[$1]=$3; ratio[$1]=$4; next} {if($1 in twin1){print $0"\t"twin1[$1]"\t"twin2[$1]"\t"ratio[$1]}}' $dirOut/TF/DMR.Cortex-HuFNSC01_Cortex-HuFNSC02.m0.75.d0.6.s300.c4.TF.summary $dirOut/TF/DMR.Brain-HuFNSC01_Brain-HuFNSC02.m0.75.d0.6.s300.c4.TF.summary | sort -k4,4n > $dirOut/TF/DMR.MZ.m0.75.d0.6.s300.c4.TF.summary.tmp
awk 'NR==FNR {twin1[$1]=$2; twin2[$1]=$3; ratio[$1]=$4; next} {if($1 in twin1){print $0"\t"twin1[$1]"\t"twin2[$1]"\t"ratio[$1]}}' $dirOut/TF/DMR.GE-HuFNSC01_GE-HuFNSC02.m0.75.d0.6.s300.c4.TF.summary $dirOut/TF/DMR.MZ.m0.75.d0.6.s300.c4.TF.summary.tmp | sort -k4,4n > $dirOut/TF/DMR.MZ.m0.75.d0.6.s300.c4.TF.summary
rm $dirOut/TF/DMR.MZ.m0.75.d0.6.s300.c4.TF.summary.tmp
