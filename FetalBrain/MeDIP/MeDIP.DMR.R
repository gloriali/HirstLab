...
venn_DMR_proximal_MZ_hypo <- venn.diagram(DMR_proximal_MZ_hypo, filename = NULL, fill = c("green", "red", "blue"), main = "Venn diagram of proximal HuFNSC02 UMRs between MZ twins", force.unique = T)
...
venn_DMR_proximal_neurospheres_hypo <- venn.diagram(DMR_proximal_neurospheres_hypo, filename = NULL, fill = c("red", "blue"), main = "Venn diagram of proximal GE UMRs between neurospheres twins", force.unique = T, na = "remove")
