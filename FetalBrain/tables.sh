...
echo -e "chr\tstart\tend\tID\tUMR\tNo.of.CpGs\tlength\tCell.types" > $dirOut/TableS2_MZ.txt
...
echo -e "chr\tstart\tend\tID\tUMR\tNo.of.CpGs\tlength\tCell.types" > $dirOut/TableS2_GW.txt
...
for mark in H3K4me1 H3K4me3 H3K9me3 H3K27me3 H3K36me3; do
    echo -e "chr\tstart\tend\tID\tcell.types\tdonor" > $dirOut'/TableS3_'$mark'.txt'
...
echo -e "ID\tRPKM1\tRPKM2\tp-value\tFDR\tDE\tCell.types" > $dirOut/TableS5_MZ.txt
...
echo -e "ID\tRPKM1\tRPKM2\tp-value\tFDR\tDE\tdonor" > $dirOut/TableS5_NPC.txt
...
echo -e "ID\tRPKM1\tRPKM2\tp-value\tFDR\tDE\tCell.types" > $dirOut/TableS5_GW.txt
