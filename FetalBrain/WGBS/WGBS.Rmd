...
## UMR genomic break down  
  ...
  + On average, `r summarise(filter(genomicBreak_WGBS_figure$data, Region == "Gene"), mean(CpG))*100`% of CpGs in UMRs overlap with genebody, and `r summarise(filter(genomicBreak_WGBS_figure$data, Region == "Promoter"), mean(CpG))*100`% of CpGs in UMRs overlap with promoters, not a significant enrichment (`r round(summarise(filter(genomicBreak_WGBS_figure$data, Region == "Promoter"), mean(CpG))/(3727169/28217448), 2)`-fold).   
