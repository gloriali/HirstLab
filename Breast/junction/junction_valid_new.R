...
write.table(lum084_myo084_isoform_all, file = "lum084_myo084_isoform_all.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(lum084_myo084_isoform_valid, file = "lum084_myo084_isoform_valid.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(lum084_myo084_isoform_all_gene, file = "lum084_myo084_isoform_all_gene.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(lum084_myo084_isoform_valid_gene, file = "lum084_myo084_isoform_valid_gene.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
write.table(lum084_stem084_isoform_all, file = "lum084_stem084_isoform_all.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(lum084_stem084_isoform_valid, file = "lum084_stem084_isoform_valid.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(lum084_stem084_isoform_all_gene, file = "lum084_stem084_isoform_all_gene.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(lum084_stem084_isoform_valid_gene, file = "lum084_stem084_isoform_valid_gene.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
write.table(myo084_stem084_isoform_all, file = "myo084_stem084_isoform_all.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(myo084_stem084_isoform_valid, file = "myo084_stem084_isoform_valid.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(myo084_stem084_isoform_all_gene, file = "myo084_stem084_isoform_all_gene.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(myo084_stem084_isoform_valid_gene, file = "myo084_stem084_isoform_valid_gene.txt", sep = "\t", quote = F, row.names = F, col.names = T)
rm(junction_exon)
