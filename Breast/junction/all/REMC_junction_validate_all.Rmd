...
```{r Nexon}
load("junction_valid_RM084.Rdata")
...
all_lm_ls_ms_erminej_BP <- read.delim("./Venn/all_lm_ls_ms_erminej_BP.txt", as.is=T, skip = 34, head = F)
all_lm_ls_ms_erminej_MF <- read.delim("./Venn/all_lm_ls_ms_erminej_MF.txt", as.is=T, skip = 34, head = F)
...
valid_lm_ls_ms_erminej_BP <- read.delim("./Venn/valid_lm_ls_ms_erminej_BP.txt", as.is=T, skip = 34, head = F)
valid_lm_ls_ms_erminej_MF <- read.delim("./Venn/valid_lm_ls_ms_erminej_MF.txt", as.is=T, skip = 34, head = F)
